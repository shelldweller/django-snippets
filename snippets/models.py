...
class Snippet(models.Model):
    ...
    is_html = models.BooleanField(_("is HTML?"), default=True,
        help_text="If checked content will be output as is and you must enter a valid HTML code.")
    is_active = models.BooleanField(_("is active"), default=True,
        help_text="""Inactive snippets will not be rendered on the web site""")
